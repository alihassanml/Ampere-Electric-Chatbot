...
const CustomerSupportChatbot = () => {
  ...
  const faqData = [
    ...
    {
      question: "What makes Ampere Electric different from other electricians?",
      answer: "Ampere Electric is a third-generation electrical company that got its start in 1987. Owner Shane Viggiani was trained by his father Lalo, who was trained by his own father. This invaluable hands-on experience ensures our team knows the exact methods and tools to deliver safe and effective electrical services."
    },
    {
      question: "What types of electrical services do you provide?",
      answer: "We provide comprehensive electrical services including outlet repairs, circuit troubleshooting, panel upgrades, lighting installation, electrical inspections, wiring services, and much more for both residential and commercial properties in Las Vegas."
    },
    {
      question: "How quickly can you respond to service calls?",
      answer: "We pride ourselves on fast response times! Many of our customers have been scheduled for same-day or next-day service, even during busy weeks. Call us at (702) 720-9545 to check availability."
    },
    {
      question: "Do you provide free estimates?",
      answer: "Yes! Contact us at (702) 720-9545 or shane@ampereelectricnv.com to schedule a free estimate for your electrical project."
    },
    {
      question: "What if my outlets suddenly stop working?",
      answer: "This is a common issue we handle frequently. It could be a tripped breaker, faulty wiring, or a GFCI issue. Our experienced technicians can quickly diagnose and fix the problem. Many customers have praised our ability to solve outlet issues that other companies couldn't figure out."
    },
    {
      question: "Are your technicians professional and courteous?",
      answer: "Absolutely! Our technicians like Nathan, David, Craig, Carlos, and Keith are known for being prompt, friendly, professional, courteous, and thorough. They explain the entire process, answer all questions, respect your property, and even clean up after themselves."
    },
    {
      question: "Do you offer warranties on your work?",
      answer: "Yes, we stand behind our work with warranties. Contact us for specific warranty details on your particular service or installation."
    },
    {
      question: "Can you help with electrical code compliance?",
      answer: "Yes! Our experienced team is well-versed in electrical codes and can ensure your electrical systems meet all safety standards and local code requirements in Las Vegas and Paradise."
    },
    {
      question: "What payment methods do you accept?",
      answer: "We accept various payment methods for your convenience. Please contact our office at (702) 720-9545 for specific payment options."
    },
    {
      question: "Do you work on both residential and commercial properties?",
      answer: "Yes, Ampere Electric provides expert electrical services for both residential homes and commercial properties throughout the Las Vegas area."
    }
  ];
        ...
        <div className="flex flex-col h-full">
          ...
          >
            ...
            <div className={`relative z-10 text-white ${screen === 'home' ? 'p-5 sm:p-6 pb-0' : 'p-4 sm:p-5'}`}>
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-2 sm:space-x-3">
                  <div className="relative">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-white to-gray-100 rounded-xl flex items-center justify-center p-1.5 sm:p-2 shadow-lg">
                      <img src="./logo.png" alt="Ampere Electric" className="w-full h-full object-contain" />
                    </div>
                  </div>

                  <div>
                    <h3 className="font-bold text-lg sm:text-xl tracking-wide">Ampere Electric</h3>
              ...
              <div className="text-xs sm:text-sm opacity-90 text-amber-100">
              ...
              <div className="h-full overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
                <div className="p-4 sm:p-5 space-y-3 sm:space-y-4">
                  <div className="text-center mb-3 sm:mb-4">
                    ...
                    <p className="text-gray-600 text-sm sm:text-base">Professional electrical services at your fingertips</p>
                  </div>
                    ...
                    {quickActions.map((action, index) => {
                      ...
                      return (
                        <button
                          ...
                          className="w-full p-3 sm:p-4 bg-white hover:bg-gray-50 rounded-2xl border-2 border-gray-200 hover:border-amber-300 transition-all duration-300 text-left group hover:shadow-xl transform hover:-translate-y-1"
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <ChevronRight className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-hover:text-amber-500 transition-all duration-300 group-hover:translate-x-1 flex-shrink-0" />
                          </div>
                        </button>
                      );
                    })}
                  ...
                  <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl border-2 border-amber-200">
                    <div className="flex items-start space-x-2 sm:space-x-3">
                      <Zap className="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0" />
                      <div>
                        <h5 className="font-bold text-slate-800 text-sm sm:text-base mb-1">Emergency Service Available</h5>
                      ...
                      <div className={`max-w-[85%] sm:max-w-[80%]`}>
                        <div className={`flex items-end space-x-2 ${msg.type === 'user' ? 'flex-row-reverse space-x-reverse' : ''}`}>
                          ...
                          <div className={`px-3 sm:px-4 py-2 sm:py-3 rounded-2xl shadow-md ${msg.type === 'user'
                            ...
                            <div className={`text-sm sm:text-base leading-relaxed ${msg.type === 'user' ? 'prose-invert' : 'prose'} prose-sm max-w-none`}>
                              <ReactMarkdown
                                components={{
                                  ...
                                  code: ({ node, inline, ...props }: any) =>
                                    inline ? (
                                      <code className={`${msg.type === 'user' ? 'bg-blue-600' : 'bg-gray-100'} px-1 py-0.5 rounded text-xs sm:text-sm`} {...props} />
                                    ) : (
                                      <code className={`block ${msg.type === 'user' ? 'bg-blue-600' : 'bg-gray-100'} p-2 rounded text-xs sm:text-sm overflow-x-auto`} {...props} />
                                    ),
                                }}
                              >
                                {msg.text}
                  ...
                  {typingMessage && (
                    <div className="flex justify-start">
                      <div className="flex items-end space-x-2">
                        <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-lg">
                          <Zap className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white" fill="white" />
                        </div>
                ...
                <div className="p-3 sm:p-4 border-t-2 border-gray-200 bg-white">
                  <div className="flex space-x-2 sm:space-x-3">
                    <input
                      ...
                      className="flex-1 px-3 sm:px-4 py-2.5 sm:py-3.5 border-2 border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent bg-gray-50 shadow-sm text-sm sm:text-base"
                    />
                    <button
                      onClick={sendMessage}
                      disabled={!input.trim() || botBusy}
                      className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-2xl flex items-center justify-center transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105"
                    >
                ...
                <div className="space-y-2 sm:space-y-3">
                  {faqData.map((faq, index) => (
                    <details key={index} className="group">
                      <summary className="flex items-center justify-between p-3 sm:p-4 bg-white hover:bg-amber-50 rounded-xl cursor-pointer transition-all duration-300 shadow-sm hover:shadow-md border border-gray-200 hover:border-amber-300">
                      ...
                      <div className="p-3 sm:p-4 pt-2 sm:pt-3 bg-white border-x border-b border-gray-200 rounded-b-xl mt-0.5">
                        ...
                        <button
                          ...
                          className="mt-2 sm:mt-3 text-sm text-amber-600 hover:text-amber-700 font-semibold flex items-center space-x-1 transition-colors"
                        >
            ...
            <div className="flex">
              {[
                ...
                return (
                  ...
                  >
                    <Icon className={`w-5 h-5 sm:w-6 sm:h-6 transition-all duration-300 ${isActive ? 'text-amber-600 scale-110' : 'text-gray-500'
                    }`} />
                    <span className={`text-xs sm:text-sm font-semibold transition-colors ${isActive ? 'text-amber-600' : 'text-gray-500'
                    }`}>
                      {item.label}
                    </span>
                    {isActive && (
                      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-10 sm:w-12 h-1 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full"></div>
                    )}
                  </button>
                );
              })}
